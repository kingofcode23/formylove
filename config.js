...
const CONFIG = {
    introTitle: 'have a happy day 😘',
    introDesc: `ờm thì anh code cái web này cũng có lí do hết á`,
    btnIntro: 'ừm hứm',
    title: 'thật ra thì có nhiều điều muốn nói nhưng có lẽ nói trực tiếp thì nó cũng hơi ngại cho cả hai',
    desc: 'nên anh nghĩ mình gửi thông điệp như này thì có lẽ sẽ dễ dàng hơn cũng như không gây khó dễ cho em trong việc quyết định',
    btnYes: '',
    btnNo: 'love you',
    question:'cho nói trước nè',
    reasonPlaceholder: 'anwser',
    btnReply: 'send',
